...
export default function Home() {
  return (
    <>
      <Head>
        <title>NextJS + Bootstrap template</title>
      </Head>

      <h3>Hello World!</h3>
      <h4>This is a simple template for getting up and running with <a href='https://getbootstrap.com/'>Bootstrap</a></h4>
      ...
      <div className='row'>
        <div className='col-3'><h5>Software</h5></div>
        <div className='col-2'><h5>Version</h5></div>
        <div className='col-5'><h5>Documentation</h5></div>
      </div>

      <div className='row'>
        <div className='col-3'>jQuery</div>
        <div className='col-2'>3.5.1</div>
        <div className='col-5'><a href='https://api.jquery.com/'>https://api.jquery.com/</a></div>
      </div>

      <div className='row'>
        <div className='col-3'>Popper.js</div>
        <div className='col-2'>1.16.0</div>
        <div className='col-5'><a href='https://popper.js.org/'>https://popper.js.org/</a></div>
      </div>

      <div className='row'>
        <div className='col-3'>Bootstrap</div>
        <div className='col-2'>4.5.0</div>
        <div className='col-5'><a href='https://getbootstrap.com/docs/4.5/getting-started/introduction/'>https://getbootstrap.com/docs/4.5/getting-started/introduction/</a></div>
      </div>
